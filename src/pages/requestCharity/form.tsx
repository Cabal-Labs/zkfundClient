...
export default function Charity(props) {
  ...
  // TODO: move this to a separate file to be used globally across the app
  const countries = [
    ...
    setModal({
      ...
      content: (
        <h6>
          ...
          charities and organizations to the platform. In the spirit of privacy
          and anonymity, we won’t be able to notify you whether the organization
          you submitted was approved or denied. Just keep an eye on the
          charities in the home screen. We try our best to handle all validation
          requests within a few days. Thanks again!
        </h6>
      ),
    });
  };
